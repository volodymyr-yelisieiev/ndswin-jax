...
class PatchEmbed(nn.Module):
    ...
    by reshaping non-overlapping patches and applying a shared linear projection.
    It works with arbitrary spatial dimensions.
    ...
    def __call__(self, x: Array) -> Array:
        ...
        # Convert to channel-last before N-D patch extraction.
    ...
    def _manual_patch_embed(
        ...
        """Patch embedding through N-D reshape and shared dense projection.
