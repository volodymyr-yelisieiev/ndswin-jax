...
def setup_logging(
    ...
    Args:
        ...
        log_file: Specific log file path (overrides log_dir auto-naming).
        log_to_file: Whether to log to file.
        log_to_console: Whether to log to console.
        use_rich: Whether to use rich formatting for console.
    """
...
def get_logger(name: str = "ndswin") -> logging.Logger:
    ...
    # Ensure logging is set up — default to console-only to avoid
    # creating empty log files when called at module import time
