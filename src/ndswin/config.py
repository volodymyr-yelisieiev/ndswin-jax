...
class DataConfig:
    ...
    # Dataset
    dataset: str = "cifar10"
    hf_id: str | None = None  # Hugging Face dataset ID (e.g., "cifar100", "user/dataset")
    data_dir: str = "data"
    download: bool = True
...
class ExperimentConfig:
    ...
    def get_stamp(self) -> str:
        """Generate a standard stamp: {name}_{hash}_{timestamp}."""
        from datetime import datetime

        # Use experiment name as the base (it already identifies the task)
    ...
    def from_dict(cls, config_dict: dict[str, Any]) -> "ExperimentConfig":
        ...
        return cls(
            ...
            description=config_dict.get("description", "No description provided"),
            model=model_config,
