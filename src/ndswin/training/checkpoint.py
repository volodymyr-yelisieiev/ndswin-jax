...
class CheckpointManager:
    ...
    def save(
        ...
        flat_params = self._build_payload(
            params, step, epoch, metrics, batch_stats, optimizer_state
        )
    ...
    def save_named(
        ...
        """Save a checkpoint with a stable filename.

        This is used for publishable artifacts such as ``best.npz`` that
        should not be removed by rolling checkpoint cleanup.
        """
    ...
    def _build_payload(
        ...
        """Build a flat checkpoint payload."""
        flat_params = {
