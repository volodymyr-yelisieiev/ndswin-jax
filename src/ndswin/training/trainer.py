...
from ndswin.training.losses import cross_entropy_loss
from ndswin.training.metrics import MetricTracker, accuracy, top_k_accuracy
...
def train_step(
    ...
    Args:
        ...
        use_batch_stats: Whether model uses batch statistics.
    ...
    def loss_fn(params: Any) -> tuple[Array, tuple[Array, Array, Array, Any]]:
        ...
        return loss, (acc, top5_acc, logits, new_batch_stats)

    # Compute gradients
    grad_fn = jax.value_and_grad(loss_fn, has_aux=True)
    (loss, (acc, top5_acc, logits, new_batch_stats)), grads = grad_fn(state.params)
