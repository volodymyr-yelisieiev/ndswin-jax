\begin{tikzpicture}
  \begin{groupplot}[
    ...
    \nextgroupplot[
      ...
      \addplot[only marks, mark=star, mark size=4pt, color=ndsred, fill=ndsred] coordinates {(7,0.7420595288276672)};
      \addlegendentry{Best checkpoint}

      \addplot[color=ndsred, dashed, line width=0.9pt] coordinates {(7,0.15) (7,1.02)};
    ...
    \nextgroupplot[
      ...
      \addplot[color=ndsred, dashed, line width=0.9pt] coordinates {(7,0.0) (7,3.8)};
  \end{groupplot}
\end{tikzpicture}
