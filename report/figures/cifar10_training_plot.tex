\begin{tikzpicture}
  \begin{groupplot}[
    ...
    \nextgroupplot[
      ...
      \addplot[only marks, mark=star, mark size=4pt, color=ndsred, fill=ndsred] coordinates {(352,0.9182000160217285)};
      \addlegendentry{Best checkpoint}

      \addplot[color=ndsred, dashed, line width=0.9pt] coordinates {(352,0.18) (352,0.96)};
    ...
    \nextgroupplot[
      ...
      \addplot[color=ndsred, dashed, line width=0.9pt] coordinates {(352,0.20) (352,2.25)};
  \end{groupplot}
\end{tikzpicture}
