\begin{tikzpicture}
  \begin{groupplot}[
    ...
    \nextgroupplot[
      ...
      \addplot[only marks, mark=star, mark size=4pt, color=ndsred, fill=ndsred] coordinates {(136,0.7480000257492065)};
      \addlegendentry{Best checkpoint}

      \addplot[color=ndsred, dashed, line width=0.9pt] coordinates {(136,0.28) (136,0.96)};
    ...
    \nextgroupplot[
      ...
      \addplot[color=ndsred, dashed, line width=0.9pt] coordinates {(136,0.55) (136,2.80)};
  \end{groupplot}
\end{tikzpicture}
