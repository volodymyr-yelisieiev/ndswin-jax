...
def test_report_extractor_syncs_latest_report_source_bundle(tmp_path: Path):
    ...
    _write_json(live / "outputs/cifar10/run/checkpoints/metrics.json", _metrics_payload())
    _write_json(live / "outputs/volume_folder/run/checkpoints/metrics.json", _metrics_payload())
    ...
    _write_json(live / "logs/queue_20260427_214146.json", [{"status": "completed"}])
    for rel in (
        "logs/tmux/benchmark/benchmark_20260427_214145.log",
        "logs/tmux/auto_sweep/autosweep_20260429_155416.log",
        "logs/cifar10/cifar10_tuned_8021c956_20260429_064522.log",
